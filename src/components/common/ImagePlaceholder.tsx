// Image placeholder component for media assets
...
export const ImagePlaceholder: React.FC<ImagePlaceholderProps> = ({
  ...
  return (
    <div
      className={cn(
        'image-placeholder rounded-sm overflow-hidden',
    ...
    >
      <div className="flex flex-col items-center justify-center p-4 text-center h-full w-full">
        ...
        {showPath && (
          <span className="text-xs text-muted-foreground/70 font-mono">{src}</span>
        )}
      </div>
    </div>
  );
