...
export const navigation: NavItem[] = [
  ...
  { label: 'About', href: '/about' },
  {
    ...
    children: [
      ...
      { label: 'Insurance Law & Risk Advisory', href: '/practice-areas/insurance-law' },
      { label: 'Labour and Employment Law', href: '/practice-areas/labour-employment' },
      { label: 'Notorial Services', href: '/practice-areas/notarial' },
      { label: 'Immigration Advisory Services', href: '/practice-areas/immigration' },
      { label: 'Advisory & Deal Structuring', href: '/practice-areas/advisory-deal-structuring' },
    ],
  },
